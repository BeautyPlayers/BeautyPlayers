     ...
     public function all_services(Request $request)
    {
               ...
               if(@$_GET['id'] == 1){
                ...
                foreach($categories as $k=>$v){
                    ...
                    $category_ids = CategoryUtility::children_ids($v->id);
                    $categories[$k]['subCategories'] = Category::select('id','parent_id','name')->whereIn('id',$category_ids)->get();
                    
                }
                
                // return $categories;
                return view('frontend.all_services', compact('categories','producstList'));
