...
(function ($) {
    ...
    var APPA = {};
    var plugin_track = '../public/js/frontend/static/plugin/';
    $.fn.exists = function () {
    ...
    * Working Contact form
    ...
    $(document).on("ready", function () {
        APPA.HeaderFixd(), APPA.masonry(), APPA.OnePage(), APPA.Counter(), APPA.HeaderHeight(), APPA.HeaderSticky(), APPA.MenuClose(), APPA.Gallery(), APPA.Accordion(), APPA.ProgressBar(), APPA.MegaMenu(), APPA.Owl(), APPA.VideoBG(), APPA.ContactForm(), APPA.SearchBox();
    });

    // Document on Scrool
    $(window).on("scroll", function () {
        APPA.ProgressBar(), APPA.HeaderFixd();
    });
