...
<style>
    ...
    <div class="">
        <form class="form form-horizontal mar-top" action="{{route('packages.store')}}" method="POST" enctype="multipart/form-data" id="choice_form">
                            ...
                            <div class="form-group row">
                                <div class="col-md-4 col-12">
                                    ...
                                    <select class="form-control aiz-selectpicker" name="type">
                                        <option value="2">{{translate('Customize')}}</option>
                                ...
                                <div class="col-md-8 col-12">
                                    ...
                                    <input type="text" class="form-control" name="name" placeholder="{{ translate('Package Name') }}" required>
                                </div>
                            </div>
                            <div class="form-group row">
                                <div class="col-md-12 col-12">
                                    ...
                                    <select class="form-control aiz-selectpicker" data-live-search="true" data-selected-text-format="count" name="select_products[]" id="select_products" multiple required>
                                        ...
                                        <option  value="{{ $product->id }}" data-content="<span><span>{{ $product->name }}</span><?= $product->brand ? '<span>[' .$product->brand->name . ']</span>'  : '' ?></span>"></option>
                            ...
                            <div class="form-group row">
                                ...
                                <div class="col-md-4">
                                    ...
                                    <div class="input-group">
                                        <input type="number" class="form-control" name="validity" min="1" step="1" placeholder="{{translate('Package Validity')}}" required>
                                ...
                                <div class="col-md-4">
                                    ...
                                    <div class="input-group">
                                        ...
                                        <input type="number" lang="en" min="0" value="0" step="0.01" placeholder="{{ translate('Special Price') }}" name="special_price" class="form-control special_price">
                                    </div>
                                </div>
                            </div>
                        </div>
