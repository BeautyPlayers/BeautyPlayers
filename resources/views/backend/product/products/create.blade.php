            ...
            <div class="col-lg-8">
                ...
                <div class="card">
                    ...
                    <div class="card-body">
                        ...
                        <div class="form-group row">
                            <label class="col-md-3 col-from-label">{{translate('Unit (number of minutes)')}}</label>
                            <div class="col-md-8">
                                <input type="text" class="form-control" name="unit" placeholder="{{ translate('Unit (Enter number of minutes)') }}" required>
                            </div>
                        </div>
                        <div class="form-group row">
                        ...
                        <div class="form-group row">
                            <div class="col-md-12 col-12">
                                ...
                                <select class="form-control aiz-selectpicker" data-live-search="true" data-selected-text-format="count" name="select_addon_products[]" id="select_addon_products" multiple>
                                    ...
                                    <option  value="{{ $select_related_product->id }}" data-content="<span><span>{{ $select_related_product->name }}</span><?= $select_related_product->brand ? '<span>[' . $select_related_product->brand->name . ']</span>' : '' ?></span>"></option>
                                    <!--<option  value="{{ $select_related_product->id }}"></option>-->
                                    @endforeach
                                </select>
                            </div>
                        </div>
