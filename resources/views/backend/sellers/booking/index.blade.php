...
<div class="aiz-titlebar text-left mt-2 mb-3">
    <div class="row align-items-center">
        <div class="col-md-6">
            <h1 class="h3">{{translate('All Sellers Bookings')}}</h1>
        </div>
    </div>
</div>
...
<div class="card">
    <form class="" id="sort_sellers" action="" method="GET">
        <div class="card-header row gutters-5">
            <div class="col">
                <h5 class="mb-md-0 h6">{{ translate('Sellers Booking') }}</h5>
            </div>
                            ...
                            <div class="dropdown">
                                ...
                                <div class="dropdown-menu dropdown-menu-right dropdown-menu-xs">
                                    @foreach(['pending', 'approved', 'decline'] as $status)
                                        <a href="{{ route('seller.bookings.status', ['id' => $shop->booking_id, 'status' => $status]) }}" class="dropdown-item {{ $shop->booking_status == $status ? 'active' : '' }}">
                                            {{translate($status)}}
                                        </a>
                                    @endforeach
                                </div>
