...
<style>
    ...
    .cat-club {  padding: 4px; margin-left: 4px; margin-right: 4px; font-size: 13px;margin-bottom: 2px; }
        ...
        <div class="container mt-3">
            ...
            <div class="mb-4">
                <h3 class="h3 fw-600 border-bottom">
                    <span class="border-bottom border-primary border-width-2 ml-3 mt-3 d-inline-block">
                        {{ translate('Products')}}
                    </span>
                </h3>
            </div>
            ...
            <nav class="nav-sections  slider nav-cat" style="top: 0px;">
                <ul class="menu regular text-center mb-0 owl-carousel owl-theme" style="max-width: initial;">
                    ...
                    if (count($featured_products)) {
                        ?>
                        <li class="menu-item item">
                            <a class="menu-item-link open-subcat active" id="0" href="#featuredPr">
                                <img style="width: 40px;/* float: left; */display: unset;"
            ...
            <main id="main-content" class="page-sections pt-4" style="z-index: 0;">
                            ...
                            <div class="col-md-12">
                                <div class="row shadow rounded">
                                    <div class="p-0 col-md-3 col-xs-4" >
                                        ...
                                        <button type=button id="ref-cpurl-btn" class="btn btn-sm ref-cpurl-btn px-2 mt-0 cat-club btn-secondary w-100 p-1" data-attrcpy="{{ translate('Copied')}}" onclick="CopyToClipboard(this)" data-id="{{ $v->id }}" data-name="{{ $v->name }}" data-url="{{$v->referral_code_url}}">{{ isset($v->referral_commission) ? $v->referral_commission : translate('Copy the Promote Link')}}</button>
            ...
            @else
            <p class="text-center">
                <h5 class="jumbotron text-center">Product unavailable</h5>
            </p>
            @endif
            </div>
        </div>
