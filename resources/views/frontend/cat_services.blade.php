...
<nav class="nav-sections  slider nav-cat" style="top: 0px;">
    <ul class="menu regular text-center mb-0" style="max-width: initial;">
        ...
        <li class="menu-item">
            <a class="menu-item-link open-subcat" id="0" href="#todeal">
                <img style="width: 100px;/* float: left; */display: unset;/* height: 33px; */padding-top: 9px;"
                     src="{{ '/public/uploads/all/LW18BKn89v8IjaKlQaVlwWYD5Ovh9oJsMWN1N9xO.png' }}" class="pt-1">
    ...
    <div class="menu-open-subcat categoryId<?= $categoryIds[$key] ?>" style="display: none">
        <nav class="nav-sections slider" style="width: 95%;background: #e2e3e7;margin-top: 1px;height: 50px;">
            <ul class="menu subcat-slider-<?= $categoryIds[$key] ?> text-center mb-0" style="max-width: initial;">
...
<main id="main-content" class="page-sections pt-4" style="z-index: 0; position: relative;top: -25px;width:100%;">
    ...
    <h2 class="mt-3 pt-3 pl-0 top-catTitle container" id="todeal" style="/* background: rgb(37, 211, 102); *//* padding: 15px; */font-size: 30px;font-weight: 700;text-transform: uppercase;color: rgb(37, 211, 102);">
        <img class="cat-image lazyload mr-2"
             src="{{ '/public/uploads/all/LW18BKn89v8IjaKlQaVlwWYD5Ovh9oJsMWN1N9xO.png' }}"
             width="60">
                ...
                <div class="col-md-12">
                    <div class="row shadow rounded">
                        <div class="p-0 col-md-3 col-xs-4" >
                            ...
                            <div class="px-2 mt-0 cat-club">Club Point: <span class="fw-700 float-right">0</span></div>
                        </div>
                            ...
                            <div class="row">
                                <div class="col-sm-12">
                                    <p class="text-right m-2 catbtnList">
                                        ...
                                        <a href="javascript:void(0)" style="/* position: relative; *//* right: 0; */margin-right: 7px;" onclick="directAddToCart({{ $v->id }})" data-toggle="tooltip" data-title="Add to cart" data-placement="bottom" tabindex="0" data-original-title="" title="">
