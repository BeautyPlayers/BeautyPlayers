...
<section class="bg-dark py-5 text-light footer-widget">
    ...
    <div class="container min-footer">
        <div id="accordion">

            <div class="card" style="border: none; margin:0;">
                <div class="card-header bg-dark text-white font-weight-bolder" style="border: none; border-bottom: 2px solid #fff; font-size:1.2rem;font-style:italic;text-decoration:none;" id="headingOne">
                    <h5 class="mb-0">
                        <button style="font-size:1.2rem;font-style:italic;text-decoration:none;font-weight:700;" class="btn btn-link collapsed" data-toggle="collapse" data-target="#collapseOne" aria-expanded="false" aria-controls="collapseOne">
                            {{ translate('Contact Info') }}
                        </button>
                    </h5>
                </div>
            ...
            <div class="card" style="border: none; margin:0;">
                <div class="card-header bg-dark text-white font-weight-bolder" style="border: none; border-bottom: 2px solid #fff; font-size:1.2rem;font-style:italic;text-decoration:none;" id="headingTwo">
                    <h5 class="mb-0">
                        <button style="font-size:1.2rem;font-style:italic;text-decoration:none;font-weight:700;" class="btn btn-link collapsed" data-toggle="collapse" data-target="#collapseTwo" aria-expanded="false" aria-controls="collapseTwo">
                            {{ get_setting('widget_one',null,App::getLocale()) }}
                        </button>
                    </h5>
                </div>
            ...
            <div class="card" style="border: none; margin:0;">
                <div class="card-header bg-dark text-white font-weight-bolder" style="border: none; border-bottom: 2px solid #fff; font-size:1.2rem;font-style:italic;text-decoration:none;" id="headingThree">
                    <h5 class="mb-0">
                        <button style="font-size:1.2rem;font-style:italic;text-decoration:none;font-weight:700;" class="btn btn-link collapsed" data-toggle="collapse" data-target="#collapseThree" aria-expanded="false" aria-controls="collapseThree">
                            {{ translate('My Account') }}
                        </button>
                    </h5>
                </div>
