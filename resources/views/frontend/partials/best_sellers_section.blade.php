...
<style>
    ...
    [dir='rtl'] .section-doctor .slick-prev {
        right: -25px;
        left: auto;
    }
    ...
    [dir='rtl'] .section-doctor .slick-prev:before {
        content: 'â†’';
    }
    .slick-next {
        right: 0;
    }
    [dir='rtl'] .section-doctor .slick-next {
        right: auto;
        left: -25px;
    }
    .section-doctor .slick-next:before {
        content: 'â†’';
    }
    [dir='rtl'] .section-doctor .slick-next:before {
        content: 'â†�';
    }
            ...
            <div class="row">
                <div class="col-lg-4">
                    <div class="section-header ">
                        <h2 class="h5 fw-700 mb-0" style="font-size: 22px;">Certified Beauty Experts</h2>
                        <!--<p><b>Certified Beauty Experts</b></p>-->
                    </div>
                    <div class="about-content">
                        <p>Discover the best beauty experts nearest to you.</p>
                        <p>Ab Aap apni Beauty Services ke liye bahut aasani se Reviews or Experience dekh kar Apne Najdeeki Certified Beauty Experts ke saath Salon at Home ka Appointment Book kar sakte hai. Beauty Players aapko 50+ categories ke saath Home Salon Service ko provide karne wale Certified Beauty Experts ke saath jodata hai.</p>					
