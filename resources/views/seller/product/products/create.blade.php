...
<div class="aiz-titlebar mt-2 mb-4">
    <div class="row align-items-center">
        <div class="col-md-6">
            <h1 class="h3">{{ translate('Choose Your Products') }}</h1>
        </div>
    </div>
</div>
...
{{--                        <label class="col-md-3 col-from-label">{{translate('Select Products')}}</label>--}}
{{--                        <div class="col-md-6">--}}
{{--                            <select class="form-control aiz-selectpicker" name="product_ids[]" id="product_ids"--}}
